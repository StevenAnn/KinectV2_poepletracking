...
//	cv::Mat depthColorShow(480,640,CV_8UC3);;
	cv::Mat depthColorShow(512, 424, CV_8UC3);;
	cv::Mat colorImage;
	int color_cols;
	int color_rows;
//------------------------------------------------
...
//	depthVideo.open("./depth.avi", CV_FOURCC('M','J','P','G') , 25, Size(64,480), true); // Size(1280,720)
//	colorVideo.open("./color.avi", CV_FOURCC('M','J','P','G') ,25, Size(640,480), true); // Size(1280,720)
	depthVideo.open("depth.avi", CV_FOURCC('M', 'J', 'P', 'G'), 25, Size(512, 424), true); // Size(1280,720)
	colorVideo.open("color.avi", CV_FOURCC('M', 'J', 'P', 'G'), 25, Size(1920, 1080), true); // Size(1280,720)
